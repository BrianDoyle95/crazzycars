                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h4 class="title"> Add brands <small class="ml-10">Home brands Add</small></h4>
                                    <p class="sub-title">brands Add</p>
                                </div>
                                <!-- /.col-md-6 -->
                        ...
                        <section class="section">
                            ...
                            <h3 class="box-title"> Add Complete Detail Of brands</h3>
							</div>
...
<div class="form-group left-icon">
                                                		<label for="name2">Name Of brand</label>
                                                        <span class="fa fa-pencil form-left-icon"></span>
                                                		<input required type="text" class="form-control" name="name" id="name2" placeholder="Name Of brand">
                                                	</div>
                                    <hr>
                                   ...
                                   <a href="brand.php" class="btn btn-danger">Back</a>
                                            ...
                                            if(isset($_POST["save"]))
											{
												 ...
												 $name=$_POST["name"];
												 $query="insert into brand set name='$name',date='$enter_date'";
