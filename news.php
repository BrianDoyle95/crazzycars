		    ...
		    <div class="tips w3l">
				<div class="container">
				 <div class="col-md-9 tips-info">
					    ...
					    <div class="news-text">
						   <h3><a href="single.html">Mercedes-Benz C250 CDI</a></h3>
							<ul class="news">
								...
								<li><i class="fa fa-envelope" aria-hidden="true"></i> <a href="#">2 Comments</a></li>
								<li><i class="fa fa-heart" aria-hidden="true"></i> <a href="#">50 Likes</a></li>
								<li><i class="fa fa-tags" aria-hidden="true"></i> <a href="#">3 Tags</a></li>
							</ul>
					 ...
					 <div class="videos">
						<h3><a href="single.html">TOP 5 UPCOMING CARS IN INDIA IN 2016</a></h3>
